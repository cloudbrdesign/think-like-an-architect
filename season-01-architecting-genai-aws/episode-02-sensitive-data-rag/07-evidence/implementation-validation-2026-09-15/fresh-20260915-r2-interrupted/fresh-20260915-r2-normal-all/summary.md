# Run fresh-20260915-r2-normal-all

- Deployment: `tla-s01e02-normal` (variant `normal`)
- Started 2026-09-15T07:48:47+00:00 · finished 2026-09-15T08:00:05+00:00
...
| `TST-OBS-001` | PASS | 90 audit items, 455 log events scanned; canary hits []; question hits 0; log hits {}; model logging enabled False |
...
| `TST-SCALE-001` | PASS | P-10 retrieved D-08: True, leaks [], constraint [926] bytes, decision 4 ms; P-11 outcome REFUSED_CONSTRAINT_INCOMPLETE, tiers []; largest application-accepted constraint (445 grants, 8177 bytes) accepted by the service:  |
...
| `TST-SEC-007` | PASS | wrong-label chunk retrieved: True; outcome WITHHELD_VERIFICATION_MISMATCH; mismatches [{'chunk_id': '04cd5954-f27f-4b41-81ab-8a7b5bcd2970', 'reason': 'LABEL_MISMATCH'}]; generation invoked False; after re-ingest D-03 §4  |
